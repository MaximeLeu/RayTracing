...
if __name__ == "__main__":
    ...
    if geometry == "small":
        ...
        rx = ground_center + np.array([[35, 5, 5], [35, -5, 5], [10, -3, -5]])
        rx = rx[2, :]
        tx = tx.reshape(-1, 3)
        rx = rx.reshape(-1, 3)
    elif geometry == "dummy":
    ...
    surfaces = [
        place.polyhedra[0].get_polygons_list()[0],
        place.polyhedra[1].get_polygons_list()[0],
        place.polyhedra[2].get_polygons_list()[0],
    ]
    for a, b, c in it:
